                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="{{route('store.profile')}}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <img id="showImage" class="rounded avatar-lg" src="{{ (!empty($editData->profile_image))? url('upload/admin_images/'.$editData->profile_image):url('upload/no_image')}}" alt="Card image cap">
                                </div>
                            </div>
                            <!-- end row -->
